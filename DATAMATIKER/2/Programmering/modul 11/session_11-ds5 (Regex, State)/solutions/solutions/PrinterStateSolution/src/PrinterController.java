import java.io.Console;
 ...
 /**
     * Simulates controlling of a printer - solution
     * 
     * @author (FEN)
     * @version (2015-03-17)
     */

enum Events { print, goReady, done, cancel, readyToPrint, unknown , paperJam};
...
class PrintController
{
    ...
    public PrintController()
    {
        ...
        printing.addTransition(Events.paperJam, error);
    ...
    private Events getNextEvent(State s)
    {
        ...
        do
        {
            ...
            else if (inputStr.equals("paperJam"))
                e = Events.paperJam;
            else
                error = true;
        } while (error);
